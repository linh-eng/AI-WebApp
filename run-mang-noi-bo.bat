@echo off
REM ===== Chay WebApp MUA HANG cho CA PHONG truy cap qua mang noi bo (LAN) =====
REM Chay file nay tren MOT may lam "may chu". Dong nghiep mo trinh duyet vao
REM dia chi IPv4 cua may nay (vd http://192.168.1.50:8010).
REM Dung cong 8010 de chay song song voi app khac (vd Kinh Doanh o cong 8000).
cd /d "%~dp0"
...
echo.
echo ==========================================================
echo   WebApp MUA HANG - DIA CHI DE DONG NGHIEP TRUY CAP:
echo.
echo   CACH 1 - Bang ten may (de nho, on dinh nhat):
echo       http://%COMPUTERNAME%:8010
echo.
echo   CACH 2 - Bang dia chi IPv4 (chon dong 192.168... hoac 10...):
ipconfig | findstr /C:"IPv4"
echo       http://[DIA-CHI-IPv4]:8010
echo.
echo   Tren chinh may nay:          http://127.0.0.1:8010
